...
from scopus_client import scopus_client as client_module
...
async def test_scopus_search_should_retry_at_most_3_times_when_json_decode_error_occurs(
    ...
    client_module.MAX_RETRIES_ON_JSON_DECODE_ERROR = 3
...
async def test_scopus_search_should_retry_at_most_3_times_when_key_error_occurs(
    ...
    client_module.MAX_RETRIES_ON_KEY_ERROR = 3
...
async def test_scopus_search_should_retry_at_most_3_times_when_internal_error_occurs(
    ...
    client_module.MAX_RETRIES_ON_SCOPUS_INTERNAL_ERROR = 3
...
async def test_scopus_search_should_retry_at_most_3_times_when_ssl_occurs(
    ...
    client_module.MAX_RETRIES_ON_SSL_ERROR = 3
