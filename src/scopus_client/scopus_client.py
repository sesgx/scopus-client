"""This module provides a Scopus client that efficiently uses your API keys."""  # noqa: E501
...
from typing import AsyncIterable, List, NoReturn, TypedDict
...
MAX_RETRIES_ON_JSON_DECODE_ERROR = 5
MAX_RETRIES_ON_KEY_ERROR = 5
MAX_RETRIES_ON_SCOPUS_INTERNAL_ERROR = 5
MAX_RETRIES_ON_SSL_ERROR = 5
...
class Page:
    ...
    Args:
        ...
        entries (list[dict]): Studies returned from the API.
    """  # noqa: E501
    ...
    current_page: int
    """Current page being fetched. Starts at 1, being at most 200, due to Scopus API 5000 entries limit."""
    entries: List[dict]
